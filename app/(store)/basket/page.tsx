    ...
    <div className="container mx-auto p-4 max-w-6xl">
      ...
      <div className=" flex flex-col lg:flex-row gap-8">
        <div className="flex-grow">
          {groupedItems.map((item) => (
            <div
              ...
              className="flex items-center justify-between mb-4 p-4 border border-rounded border-gray-200"
            >
              <div
        ...
        <div className="w-full lg:w-80 lg:sticky lg:top-4 h-fit bg-white p-6 border rounded order-first lg:order-last fixed bottom-0 left-0 lg:left-auto">
          ...
          {isSignedIn ? (
            <button
              onClick={handleCheckout} // Pass the function reference instead of invoking it
              disabled={isLoading}
              className="w-full mt-4 bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded disabled:bg-gray-400"
            >
